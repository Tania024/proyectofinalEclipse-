...
a persistence unit "BibliotecaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Biblioteca/pom.xml":
...
artifact ("Biblioteca.war") is already built. You can build
